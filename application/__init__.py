...
def create_app():
    ...
    # 注册蓝图
    from application.views import front # 位置不要放上面 如果你的view界面展示也在`__init__`下面, 那就把view展示相关的代码移到最下面，因为python先执行view.py相关界面，而此时db还没有创建，就会报这个错误
    ...
    # from application.modelview import UModelview, BaseMView, ArticleVModel
    #
